...
### 4.1a Comparison with published literature
...
Source data were obtained from the publicly accessible WHO GLASS-AMR dashboard (https://worldhealthorg.shinyapps.io/glass-dashboard/). Analysis code and combined datasets are available at https://github.com/DocWaqas/acinetobacter-carbapenem-glass-trends-or-crab-glass-2020-2023.

## Author Contributions

[Your name] conceived the analysis, collected and processed the data, conducted the analysis, and drafted the manuscript.
...
**Note on current draft status:** Figures 1 and 2 are complete and embedded above, the GitHub repository link is live, and all five references are now verified against primary sources, including reference 2, corrected to its actual publication year (2023, not 2024) after the author checked it directly against the WHO source page. Remaining before submission: the author's own full read-through of the abstract and conclusion for tone and framing.
